...
function Nav() {
  ...
  return (
    <div className="bg-transparent z-50 absolute w-full">
        <div className='flex items-center py-6 bg-transparent text-white text-sm border-b border-gray-800'>
            <div className='flex items-center justify-between w-4/5 m-auto relative z-50'>
                <div>
                    <ul className='flex'>
                        <li className='flex items-center mr-4 relative' onMouseEnter={() => handleMouseEnter('gaming')} onMouseLeave={handleMouseLeave}>
                            <span className='hover:cursor-pointer'>Gaming Accessories</span> <RiArrowDropDownLine className='text-purple-800' style={{ fontSize: "20px" }} />
                        ...
                        <li className='flex items-center mr-4 relative' onMouseEnter={() => handleMouseEnter('pages')} onMouseLeave={handleMouseLeave}>
                            <span className='hover:cursor-pointer'>Pages </span> <RiArrowDropDownLine className='text-purple-800' style={{ fontSize: "20px" }} />
                        ...
                        <li className='flex items-center mr-4 relative' onMouseEnter={() => handleMouseEnter('blog')} onMouseLeave={handleMouseLeave}>
                            <span className='hover:cursor-pointer'>Blog</span> <RiArrowDropDownLine className='text-purple-800' style={{ fontSize: "20px" }} />
                            {dropdownContent === 'blog' && (
                                <div className="absolute top-full left-0 mt-1 w-32 bg-gray-900 rounded-lg p-2 text-xs z-50 shadow-md" onMouseEnter={() => handleMouseEnter('blog')} onMouseLeave={handleDropdownMouseLeave}>
                                    {/* Dropdown content for Blog */}
                                    <a href="#" className="block py-1 hover:bg-gray-800 transition duration-300 px-4">Tech Reviews</a>
                                    <a href="#" className="block py-1 hover:bg-gray-800 transition duration-300 px-4">Game Reviews</a>
